...
function isNearBottom(_container, thresholdPx = 120) {
...
function ensureAutoScrollTracking(container) {
    ...
    addRootScrollListener(() => {
        ...
        const prev = typeof container.__cerebrLastScrollTop === 'number'
            ...
            : currentScrollTop;
        const delta = currentScrollTop - prev;
        container.__cerebrLastScrollTop = currentScrollTop;
