import { addRootScrollListener, getClientHeight, getScrollHeight, getScrollTop, isKeyboardScrollMode, removeRootScrollListener, scrollToTop } from './scroll-root.js';
...
export function createReadingProgressManager({
    ...
    const saveNow = async (chatId = getActiveChatId?.()) => {
        ...
        if (isKeyboardScrollMode()) return;
