...
import { getClientHeight, getScrollHeight, getScrollTop, scrollToTop, addRootScrollListener } from './utils/scroll-root.js';
...
const onDomReady = async () => {
    try {
        ...
        const isNearBottom = (_container, thresholdPx = 120) => {
            const remaining = getScrollHeight() - getScrollTop() - getClientHeight();
        ...
        const initScrollToBottomButton = () => {
            ...
            const scrollToBottom = (behavior = 'smooth') => {
                ...
                scrollToTop(getScrollHeight(), behavior);
                scheduleUpdate();
            };
            ...
            addRootScrollListener(scheduleUpdate, { passive: true });
