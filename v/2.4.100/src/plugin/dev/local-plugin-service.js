...
import { materializePluginI18n } from '../core/plugin-i18n.js';
...
async function buildLocalPluginPackage(manifest, sourceMeta = {}) {
    ...
    return materializePluginI18n(pluginPackage, {
        bundleFiles: bundle?.files || null,
        manifestPath: bundle?.manifestPath || 'plugin.json',
...
async function installLocalScriptPluginPackage(manifest, sourceMeta = {}) {
    ...
    const pluginPackage = await buildLocalPluginPackage(manifest, sourceMeta);
